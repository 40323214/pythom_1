...
class Application(object):
    ...
    def __init__(self):
        ...
        self.github_repo_url = 'https://github.com/40323253/-2014cp_project_40323253'
        # 你的 openshift app
        self.openshift_url = 'http://2014project-40323253.rhcloud.com/'
        # 你的自評
        self.evaluation = [('Project 7', 90), ('Project 8', 90), ('Project 9', 85)]
        # 你的照片 url
        self.photo_url = 'https://copy.com/FgRoulS6nTr8gmeG'
        # 這裡是心得
        self.my_remark = """
        時間飛逝，一轉眼半學期過去了，大學生活走了八分之一，漸漸熟悉大學的學習環境。計算機程式這門課是我們設計的基礎，
        如何用程式語言和人溝通，是我們學習的目的。本學期的課程帶我們進入Python的世界，從打造可攜程式環境，建立OpenShift
        上的Brython程式環境，到利用Python列出字串，每份作業、每個挑戰都讓我們學習和成長。在這也感謝老師和TA的教導、同學
        們的付出及幫助，透過期末報告的總整理，讓我重新吸收了機算機程式這門課的精華。
        """
