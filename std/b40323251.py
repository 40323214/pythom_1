...
class Application(object):
    ...
    def __init__(self):
        ...
        self.github_repo_url = 'https://github.com/40323251/2014_cpb'
        # 你的 openshift app
        self.openshift_url = 'http://2014cpbopenshift-40323251.rhcloud.com/'
        # 你的自評
        self.evaluation = [('期末自評分數', 80)]
        # 你的照片 url
        self.photo_url = 'https://copy.com/jl2qqQhQpm3j'
        # 這裡是心得
        self.my_remark = """
        python心得
        """
