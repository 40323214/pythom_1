...
class Application(object):
    ...
    def __init__(self):
        ...
        self.github_repo_url = 'https://github.com/yoyo6432/40323241-1'
        # 你的 openshift app
        self.openshift_url = 'http://40323241-40323241.rhcloud.com/'
        # 你的自評
        self.evaluation = [('期末自評分數',70)]
        # 你的照片 url
        self.photo_url = 'https://copy.com/3lX9AN0dML1W'
        # 這裡是心得
        self.my_remark = """
