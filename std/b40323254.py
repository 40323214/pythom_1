...
class Application(object):
    ...
    def __init__(self):
        ...
        self.github_repo_url = 'https://github.com/TSAIPO/40323254cp'
        # 你的 openshift app
        self.openshift_url = 'http://40323254-40323254.rhcloud.com/'
        # 你的自評
        self.evaluation = [('Project 7', 75), ('Project 8', 75), ('Project 9', 75)]
        # 你的照片 url
        self.photo_url = 'https://copy.com/W1XeWQJUBlwMBZjE'
        # 這裡是心得
        self.my_remark = """
        心得報告：
每次上課聽老師的講解雖然常常一知半解，有時連一半都不知道，但在同學的幫助下已經可以把功課做出來了。
這學期學會如何使用在openshift建立內容、在github建立倉儲、在Leo Editer管理自己的內容，只能說學會了太多太多，但也因為在多了搞得我也暈頭轉向的。
感謝這學期老師的努力教學，也感謝同學們的幫助幫助我解決許多困難。
